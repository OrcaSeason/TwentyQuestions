...
public class GameManager {
    ...
    public boolean startGame(Player initiator) {
        plugin.getLogger().info("Starting game, current state: " + gameState + ", initiator: " + initiator.getName());
        ...
        plugin.getLogger().info("Game started, state: " + gameState + ", questioner: " + (questioner != null ? questioner.getName() : "null"));
        ...
        if (questioner != null) {
            ...
            plugin.getLogger().severe("Questioner is null after assignment!");
        }
        return true;
    }
    ...
    public void nextPlayer() {
        ...
        if (previousPlayer != null && availablePlayers.size() > 1) {
        ...
        currentPlayer = availablePlayers.get(randomIndex);

        previousPlayer = currentPlayer;

        plugin.getLogger().info("Next player selected: " + currentPlayer.getName());
        announceCurrentPlayer();
        resetPlayerTimeout();
        players.forEach(scoreboardManager::updateScoreboard);
    }
